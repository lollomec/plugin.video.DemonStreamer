...
def download_and_install(remote_file_name, local_file_name):
    ...
    path_channels=xbmc.translatePath("special://home/addons/plugin.video.DemonStreamer/channels")
    filetools.rmdirtree(path_channels)
    path_servers=xbmc.translatePath("special://home/addons/plugin.video.DemonStreamer/servers")
